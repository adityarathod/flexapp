...
const ColorfulCard = props => (
    <div className="card" style={{ background: props.color, boxShadow: "0px 16px 16px rgba(0, 0, 0, 0.16)", borderRadius: "14px", width: '100%', height: '124px', padding: '18px', marginBottom: '24px', maxWidth: '900px' }}>
